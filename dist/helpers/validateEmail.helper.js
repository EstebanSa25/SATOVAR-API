...
exports.EmailValidationSuccess = exports.ForgotPasswordEmail = exports.validateEmail = void 0;
const validateEmail = (link, email) => {
    return `<head>
...
const ForgotPasswordEmail = (link, email) => {
    return `<head>
...
exports.EmailValidationSuccess = EmailValidationSuccess;
